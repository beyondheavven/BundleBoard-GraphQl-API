...
-- TRUNCATE users, tags, images, media_resources CASCADE;

-- 1.USERS
INSERT INTO users (username, email, role, password_hash, avatar_url, status) VALUES
                                                                                 ('admin_max', 'admin@platform.com', 'admin', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1', 'https://cdn.com/avatars/1.jpg', 'active'),
                                                                                 ('sergey_vfx', 'sergey@vfx.com', 'author', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1', 'https://cdn.com/avatars/2.jpg', 'active'),
                                                                                 ('elena_design', 'elena@design.com', 'author', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1', 'https://cdn.com/avatars/3.jpg', 'active'),
                                                                                 ('ivan_buyer', 'ivan@mail.com', 'client', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1', 'https://cdn.com/avatars/4.jpg', 'active'),
                                                                                 ('olga_creative', 'olga@mail.com', 'client', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1', 'https://cdn.com/avatars/5.jpg', 'inactive');
...
INSERT INTO collection_tags (tags_id, collections_id) VALUES
                                                          (2, 1), (3, 1), -- Fire VFX: VFX, After Effects
                                                          (1, 2), (6, 2); -- HUD Kit: 3D Modeling, UI Kit
...
-- 11.REFRESH_TOKEN
INSERT INTO refresh_token (users_id, token, status) VALUES
                                                        (1, 'long-random-jwt-token-string-for-admin', 'active'),
                                                        (4, 'long-random-jwt-token-string-for-ivan', 'active');