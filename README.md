...
Fully reactive backend API driving the **BundleBoard** marketplace—a specialized e-commerce and digital asset aggregation platform optimized for design resources (Adobe Photoshop and Adobe Illustrator templates, textures, brushes, and gradient maps).
...
> ![C4 structure](images/level1_c4.png)
...
> ![JaCoCo Code Coverage Report](images/JaCoCo_Report.png)
