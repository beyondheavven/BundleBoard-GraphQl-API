...
INSERT INTO users (username, email, roles, password_hash, avatar_url, status, last_login_at, created_at) VALUES
                                                                                                             ('admin_max', 'admin@platform.com', '{admin}', '$2a$12$SARyXyDhUArvPDpnxw8XseQ07ynrdJaNE8.7PhHEeCujVaPc9yh4G', 'https://cdn.com/avatars/1.jpg', 'active', NOW(), NOW()),
                                                                                                             ('sergey_vfx', 'sergey@vfx.com', '{author}', '$2a$12$SARyXyDhUArvPDpnxw8XseQ07ynrdJaNE8.7PhHEeCujVaPc9yh4G', 'https://cdn.com/avatars/2.jpg', 'active', NOW(), NOW()),
                                                                                                             ('elena_design', 'elena@design.com', '{author}', '$2a$12$SARyXyDhUArvPDpnxw8XseQ07ynrdJaNE8.7PhHEeCujVaPc9yh4G', 'https://cdn.com/avatars/3.jpg', 'active', NOW(), NOW()),
                                                                                                             ('ivan_buyer', 'ivan@mail.com', '{client}', '$2a$12$SARyXyDhUArvPDpnxw8XseQ07ynrdJaNE8.7PhHEeCujVaPc9yh4G', 'https://cdn.com/avatars/4.jpg', 'active', NOW(), NOW()),
                                                                                                             ('olga_creative', 'olga@mail.com', '{client}', '$2a$12$SARyXyDhUArvPDpnxw8XseQ07ynrdJaNE8.7PhHEeCujVaPc9yh4G', 'https://cdn.com/avatars/5.jpg', 'inactive', NULL, NOW());
